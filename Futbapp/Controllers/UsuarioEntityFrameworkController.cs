...
{
    public class UsuarioEntityFrameworkController : Controller
    {
        private FutbappContext db = new FutbappContext();

        // GET: UsuarioEntityFramework
        public ActionResult Index()
        {
            return View(db.Usuarios.ToList());
        }

        // GET: UsuarioEntityFramework/Details/5
        ...
        // GET: UsuarioEntityFramework/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: UsuarioEntityFramework/Create
        ...
        // GET: UsuarioEntityFramework/Edit/5
        ...
        // POST: UsuarioEntityFramework/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: UsuarioEntityFramework/Delete/5
        ...
        // POST: UsuarioEntityFramework/Delete/5
